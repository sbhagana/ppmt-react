...
import com.ppmtoolfullstack.ppmt.services.ProjectTaskService;
...
public class BacklogController {
    ...
    @Autowired
    private ErrorValidationHandlerService mapValidationErrorService;
    ...
    public ResponseEntity<?> addPTtoBacklog(@Valid @RequestBody ProjectTask projectTask,
        ...
        ResponseEntity<?> errorMap = mapValidationErrorService.ErrorValidationHandler(result);
